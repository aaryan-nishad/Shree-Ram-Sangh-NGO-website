...
const missions = [
...

  {
    ...
    shortDescription:
      '[MISSION SUMMARY] We work to restore historic temples and keep living cultural and spiritual traditions active within the community, rather than letting them fade with time.',
    fullDescription:
...

  {
    ...
    shortDescription:
      '[MISSION SUMMARY] We organise tree plantation drives, water conservation efforts and local cleanliness campaigns, treating environmental care as a shared community responsibility.',
    fullDescription:
...

  {
    ...
    shortDescription:
      '[MISSION SUMMARY] We arrange food, shelter and medical care for stray and abandoned animals and birds, and encourage everyday compassion toward all living beings.',
    fullDescription:
